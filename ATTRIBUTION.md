...
### Derived — Overgrown biome sheet (from Kenney Tiny Dungeon)
...
- License URL: https://creativecommons.org/publicdomain/zero/1.0/
- Used for: the depth-biome tile kit for floors 5–9 (M15). Shipped as
  `client/public/assets/tiny-dungeon/tilemap_overgrown.png` — a full clone of
  the packed sheet with the 19 wall/floor/void kit tiles re-derived (explicit
  palette remap to gray-green stone + warm turf, plus rule-placed detail:
  hanging vines, underside moss, leaf-litter/moss floor variants) and one
  extension row (frames 132–136) of anti-tiling wall variants: 132–134 =
  brick-face (#40) rolls, 135–136 = back-edge (#26) rolls. All other frames
  are unmodified so sprite indices stay identical across sheets.
